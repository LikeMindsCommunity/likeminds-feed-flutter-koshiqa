...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/flutter_notification_channel/flutter_notification_channel.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/simple_s3/simple_s3.framework"
