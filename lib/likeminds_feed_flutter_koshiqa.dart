...
class LMFeedKoshiqa extends StatefulWidget {
  ...
  static Future<void> setupFeed(
    ...
    // LMFeedTimeAgo.instance.setDefaultTimeFormat(KoshiqaCustomTimeStamps());
  }
}
...
class _LMFeedKoshiqaState extends State<LMFeedKoshiqa> {
  ...
  void initState() {
    ...
    if (widget.userId != null) {
      requestBuilder.uuid(widget.userId!);
    }
                ...
                builder: (context, snapshot) {
                  if (snapshot.hasData && snapshot.data!.success) {
                    return const LMFeedScreen(
                        ...
                        //             textStyle: TextStyle(
                        //               color: KoshiqaTheme.onContainer,
                        //               fontSize: 22,
